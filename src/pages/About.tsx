  ...
  return (
    <div className={`min-h-screen ${theme.background} ${theme.primaryText}`}>
      <section className="mx-auto w-full max-w-screen-lg px-4 py-16 md:py-24">
        <p className={`text-xs md:text-sm uppercase tracking-[0.22em] ${theme.secondaryText}`}>About Lovable</p>
        ...
        <p className={`mt-6 max-w-3xl text-base md:text-lg leading-relaxed ${theme.secondaryText}`}>
          Lovable is designed like a lightweight SaaS flow: clear creator tools, polished viewer delivery, and clean data handling on Firebase.
